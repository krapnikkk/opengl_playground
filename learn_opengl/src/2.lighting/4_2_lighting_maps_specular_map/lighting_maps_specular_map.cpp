...
int main()
{
	...
	Shader shader("src/2.lighting/4_2_lighting_maps_specular_map/shader.vert", "src/2.lighting/4_2_lighting_maps_specular_map/shader.frag");
	Shader lightCubeShader("src/2.lighting/4_2_lighting_maps_specular_map/light_cube.vert", "src/2.lighting/4_2_lighting_maps_specular_map/light_cube.frag");
