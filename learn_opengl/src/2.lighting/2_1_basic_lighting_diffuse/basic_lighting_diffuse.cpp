...
int main()
{
	...
	Shader shader("src/2.lighting/2_1_basic_lighting_diffuse/shader.vert", "src/2.lighting/2_1_basic_lighting_diffuse/shader.frag");
	Shader lightCubeShader("src/2.lighting/2_1_basic_lighting_diffuse/light_cube.vert", "src/2.lighting/2_1_basic_lighting_diffuse/light_cube.frag");
