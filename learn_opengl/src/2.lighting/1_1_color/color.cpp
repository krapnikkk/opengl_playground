...
int main()
{
	...
	Shader shader("src/2.lighting/1_1_color/shader.vert", "src/2.lighting/1_1_color/shader.frag");
	Shader lightCubeShader("src/2.lighting/1_1_color/light_cube.vert", "src/2.lighting/1_1_color/light_cube.frag");
