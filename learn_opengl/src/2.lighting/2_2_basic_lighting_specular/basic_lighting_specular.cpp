...
int main()
{
	...
	Shader shader("src/2.lighting/2_2_basic_lighting_specular/shader.vert", "src/2.lighting/2_2_basic_lighting_specular/shader.frag");
	Shader lightCubeShader("src/2.lighting/2_2_basic_lighting_specular/light_cube.vert", "src/2.lighting/2_2_basic_lighting_specular/light_cube.frag");
