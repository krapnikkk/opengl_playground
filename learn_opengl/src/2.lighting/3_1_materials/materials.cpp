...
int main()
{
	...
	Shader shader("src/2.lighting/3_1_materials/shader.vert", "src/2.lighting/3_1_materials/shader.frag");
	Shader lightCubeShader("src/2.lighting/3_1_materials/light_cube.vert", "src/2.lighting/3_1_materials/light_cube.frag");
