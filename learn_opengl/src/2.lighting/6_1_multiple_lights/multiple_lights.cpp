...
int main()
{
	...
	Shader shader("src/2.lighting/6_1_multiple_lights/shader.vert", "src/2.lighting/6_1_multiple_lights/shader.frag");
	Shader lightCubeShader("src/2.lighting/6_1_multiple_lights/light_cube.vert", "src/2.lighting/6_1_multiple_lights/light_cube.frag");
